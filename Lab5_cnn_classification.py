...
train_dataset = torchvision.datasets.ImageFolder(root='C:/Users/Вадим/Desktop/Нейронки/5_Image_classification/data/train',
                                                 transform=data_transforms)
test_dataset = torchvision.datasets.ImageFolder(root='C:/Users/Вадим/Desktop/Нейронки/5_Image_classification/data/test',
                                             transform=data_transforms)
...
print('Точность модели: ' + str(100 * correct_predictions / num_train_samples) + '%') # явно требуется обучение
...
print('Точность модели: ' + str(100 * correct_predictions / num_train_samples) + '%')
